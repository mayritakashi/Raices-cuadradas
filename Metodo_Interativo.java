 ...
 * @author vya-a
 */
public class Metodo_Interativo {
    static double resultado=0,b=0,h=0,Area=0,error=0,Altura=0,base=0,raiz=0,numero=0,xn=0;
       ...
       if(raiz>=1){
        ...
        for(b=1;resultado<=raiz;b++){//aqui hacemos un bucle para que cada que multiplique se vaya sumando uno ala b y luego entre en condicion si es menor el resultado
            ...
            if(resultado<=raiz){//aqui comparamos el resultado con el de la raiz para que pueda entrar
                ...
                numero=b;
                System.out.println("tu base es: "+String.format("%."+decimales+"f",numero));
                System.out.println("tu resultado es: "+String.format("%."+decimales+"f",resultado));
                
                
                xn=(((1)*((numero)+(raiz/numero)))/2);
                
                System.out.println("tu raiz es de: "+String.format("%."+decimales+"f",xn));
           ...
           for(base=0.1;resultado<raiz;base++){
               //base=base+1;esto es igual a base++ pero de la forma
               //base=base+0.1;
               //base=base+(0.1);
               resultado=base*base;  
